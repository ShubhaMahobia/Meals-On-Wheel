...
<!-- Start content -->
    <div class="container">
        <div class="row">
            ...
            <button type="button" class="btn btn-outline-success mt-4 mb-4">Add New Meal</button>
            </a>
            </div>
        </div>
                      ...
                      <div class="menu-group">
                        <div class="menu-item">
                          ...
                          <div class="menu-item-text">
                            ...
                            <a href="{{ route('partner#editMeal', $meal->id) }}" style="text-decoration: none; margin:0px 0px 4px 300px;">
                                <button type="button" class="btn btn-outline-primary" id="edit" style="margin-bottom: 16px;">
                                    <i class="fa fa-edit" style="padding: 2px 8px ;"></i> Edit Meal</button>
                                </a>
                    
                                <a href="{{ route('partner#deleteMeal', $meal->id) }}" style="text-decoration: none; margin:0px 0px 0px 300px; ">
                                <button type="button" class="btn btn-outline-danger" id="delete">
                                    <i class="fa fa-trash"></i> Delete Meal</button>
                                </a>
                          </div>
