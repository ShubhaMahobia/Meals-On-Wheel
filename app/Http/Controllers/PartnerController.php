...
class PartnerController extends Controller
{
    ...
    public function createMeal(Request $request)
    {
       $validator = Validator::make($request->all(), [
            ...
            'meal_type' => 'required',
            'meal_image' => 'required',
            'meal_partner_longitude' => 'required',
            'meal_partner_latitude' => 'required'
        ...
        $meal->meal_partner_longitude = $request->input('meal_partner_longitude');
        $meal->meal_partner_latitude = $request->input('meal_partner_latitude');
